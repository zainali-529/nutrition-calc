...
export function IngredientDetailModal({
  ...
  if (!ingredient || !mounted || typeof document === 'undefined') return null;
      ...
      {isOpen && (
        <div className="fixed inset-0 z-[100000] flex items-center justify-center p-3 sm:p-5 md:p-6 overflow-hidden pointer-events-auto">
          ...
          >
            ...
            <div className="relative bg-gradient-to-r from-emerald-600 via-emerald-600 to-teal-700 px-4 sm:px-6 py-4 text-white flex-shrink-0 shadow-xs">
              <div className="flex items-start justify-between gap-3">
                <div className="flex-1 min-w-0">
                  ...
                  <div className="flex flex-wrap gap-1.5 sm:gap-2 mt-1.5">
                    <div
                      className={`px-2.5 py-0.5 sm:px-3 sm:py-1 rounded-full text-[11px] sm:text-xs font-semibold border ${getIntensityColor(
